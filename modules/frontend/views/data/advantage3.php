        ...
        <div class="main-l fl">
            ...
            <div class="main-l-bd">
                <ul>
                    ...
                    <li class="on"><a href="<?=GlobalUrlService::buildAppUrl('/advantage',['type'=>3])?>">加盟优势</a></li>
                </ul>
            ...
            <div class="main-r-hd clearfix">
                ...
                <div class="main-r-hd-r fr">
                     <span>您目前所在页面：<a href="/">首页</a> > <a href="<?=GlobalUrlService::buildAppUrl('/advantage')?>">项目优势</a> >
                        <a href="<?=GlobalUrlService::buildAppUrl('/advantage',['type'=>3])?>">加盟优势</a></span>
                </div>
            </div>
            <div class="main-r-bd">
                <img class="bigImage" src="images/joinAdv.png" alt="" />
            </div>
